...
Windows: [Windows direct link](https://drive.google.com/uc?export=download&id=1_etRzh6dzeSGqj70fnP5dM1LbdTEAvla)<br>
...
1. Run below code in your terminal.
   ...
   ```
   git clone https://github.com/bitan07-dev/to-do-list.git
   ```
